...
//            var Query = personGHRepository.GetAll().Include(p => p.Person_Tbl).Include(p => p.Markaz_Tbl)
//                .ThenInclude(p => p.Bakhsh_Tbl).AsQueryable();
//            //if (Query !=null)
//            //{
//            //    foreach (var item in Query)
//            //    {
//            //        applicationDbContext.Entry(item).Reference(p => p.Person_Tbl).Load();
//            //        applicationDbContext.Entry(item).Reference(p => p.Markaz_Tbl).Load();
...
//                Person_Name = x.Person_Tbl.Person_Name + " " + x.Person_Tbl.Person_Family ?? "ندارد",
//                Markaz_Name = x.Markaz_Tbl.Markaz_Name ?? "ندارد",
